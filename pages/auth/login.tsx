        ...
        <div className="container mx-auto">
            <div className="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm light:bg-neutral-900 light:border-neutral-700">
                <div className="p-4 sm:p-7">
                    ...
                    <h1 className="block text-2xl font-bold text-gray-800 light:text-white">Sign in</h1>
                    <p className="mt-2 text-sm text-gray-600 light:text-neutral-400">
                        Don't have an account yet?
                        <Link className="text-blue-600 decoration-2 hover:underline font-medium light:text-blue-500" href="/auth/registration">
                        &nbsp;Sign up here
                        </Link>
                    </p>
                    </div>
                    ...
                    <div className="py-3 flex items-center text-xs text-gray-400 uppercase before:flex-1 before:border-t before:border-gray-200 before:me-6 after:flex-1 after:border-t after:border-gray-200 after:ms-6 light:text-neutral-500 light:before:border-neutral-600 light:after:border-neutral-600">Or</div>
                    ...
                    <form>
                        ...
                        <div>
                            ...
                            <label htmlFor="password" className="block text-sm mb-2 light:text-white">Password</label>
                            <Link className="text-sm text-blue-600 decoration-2 hover:underline font-medium" href="/auth/forget">Forgot password?</Link>
                            </div>
                            <div className="relative">
                        ...
                        <div className="flex items-center">
                            <div className="flex">
                            <input id="remember-me" name="remember-me" type="checkbox" className="shrink-0 mt-0.5 border-gray-200 rounded text-blue-600 focus:ring-blue-500 light:bg-neutral-800 light:border-neutral-700 light:checked:bg-blue-500 light:checked:border-blue-500 light:focus:ring-offset-gray-800" />
                            </div>
                            <div className="ms-3">
                            <label htmlFor="remember-me" className="text-sm light:text-white">Remember me</label>
                            </div>
                        </div>
                        {/* Remember Checkbox Form */}
